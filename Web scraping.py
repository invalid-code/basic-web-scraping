...
for chapter_name in manga_name_chapter:
    latest_manga[chapter_name.h4.text] = chapter_name.ul.find_all(text=re.findall('Ch\. \d*\.?\d*', str(chapter_name.ul)))
print(latest_manga)